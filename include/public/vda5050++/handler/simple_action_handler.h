...
#ifndef PUBLIC_VDA5050_2B_2B_HANDLER_SIMPLE_ACTION_HANDLER_H_
#define PUBLIC_VDA5050_2B_2B_HANDLER_SIMPLE_ACTION_HANDLER_H_
...
///
///\brief A SimpleActionHandler which will automatically take care of:
/// - Matching
...
///
class SimpleActionHandler : public BaseActionHandler {
private:
  vda5050pp::agv_description::ActionDeclaration decl_;

public:
  ~SimpleActionHandler() override = default;

  ///
  ///\brief Construct a new SimpleActionHandler.
  ///
  ///\param action_declaration a declaration for the handled action (used for auto
  /// validation/matching/factsheet).
  ///
  explicit SimpleActionHandler(
      const agv_description::ActionDeclaration &action_declaration) noexcept(true)
      : decl_(action_declaration) {}
...
#endif  // PUBLIC_VDA5050_2B_2B_HANDLER_SIMPLE_ACTION_HANDLER_H_
